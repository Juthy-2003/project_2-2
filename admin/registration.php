			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title reg">Registration </h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									<div class=" head">Fill all Info</div>
...
<input type="radio" value="1" name="foodstatus"> With Food(2000.00 Taka Per Month Extra)
</div>
</div>	
