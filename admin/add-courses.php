			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title head">Add Courses </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class=" head-title">Add courses</div>
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Department/Institute Name (Short)</label>
												<div class="col-sm-8">
...
<div class="form-group">
									<label class="col-sm-2 control-label">Department/Institute Name(Full)</label>
									<div class="col-sm-8">
									<input type="text" class="form-control" name="cnf" value="" >
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary bg" type="submit" name="submit" value="Add Department">
												</div>
											</div>
