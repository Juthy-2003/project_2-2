...
<head>
	...
	<link rel="stylesheet" href="./manage-course.css">
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title head" style="margin-top:4%">Manage Course</h2>
						<div class="panel panel-default">
							<div class=" head-title">All Courses Details</div>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
										    <th>Sl No</th>
											<th>Faculty Name</th>
											<th>Department/Institute Name(Short)</th>
											<th>Department/Institute Name(Full)</th>
											<th>Regd Date</th>
											<th>Action</th>	
										</tr>
									</thead>
