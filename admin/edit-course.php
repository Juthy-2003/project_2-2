			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Departments/Institutes </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Edit Departments/Institutes </div>
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
				 ...
				 <div class="form-group">
				<label class="col-sm-2 control-label">Departments/Institutes Name (Short)</label>
		<div class="col-sm-8">
	<input type="text" class="form-control" name="cns" id="cns" value="<?php echo $row->course_sn;?>" required="required">
						 </div>
						</div>
<div class="form-group">
									<label class="col-sm-2 control-label">Departments/Institutes Name(Full)</label>
									<div class="col-sm-8">
