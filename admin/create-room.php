...
<head>
	...
	<link rel="stylesheet" href="./create-room.css">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title head">Add a Room </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class=" head-title">Add a Room</div>
...
<input class="btn btn-primary bg" type="submit" name="submit" value="Create Room ">
												</div>
											</div>
