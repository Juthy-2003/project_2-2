				...
				<div class="row">
					...
					<div class="col-md-6 col-md-offset-3">
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									<label for="" class="text-uppercase text-sm textColor">Email / Registration Number</label>
									<input type="text" placeholder="Email / Registration Number" name="emailreg" class="form-control mb" required="true">
									<label for="" class="text-uppercase text-sm textColor">Password</label>
						...
						<div class="text-center text-light" style="color:black;">
							<a href="forgot-password.php" style="color:black; background:red;padding:10px;border-radius:10px;color:white;font-size:20px;">Forgot my  password?</a>
						</div>
					</div>
				</div>
						</div>
