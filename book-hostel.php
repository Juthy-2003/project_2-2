...
$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,bloodgroup,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisisissssissississsisssi',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$bloodgroup,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
...
<head>
	...
	<link rel="stylesheet" href="css/bookHostel.css">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									<div class="head-title">Fill all Info</div>
...
<label class="col-sm-4 control-label text-blue"><h4 align="left">Room Related info </h4> </label>
</div>
...
<input type="radio" value="1" name="foodstatus"> With Food(2000.00 tk Per Month Extra)
</div>
</div>	
...
<div class="form-group">
<label class="col-sm-2 control-label text-blue"><h4 align="left">Personal info </h4> </label>
</div>
...
<div class="col-sm-8">
<input type="text" name="contact" id="contact" value="0<?php echo $row->contactNo;?>"  class="form-control" readonly>
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="bloodgroup" id="bloodgroup" value="<?php echo $row->bloodgroup;?>"  class="form-control" readonly>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label text-blue"><h4 align="left">Correspondense Address </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label text-blue"><h4 align="left">Permanent Address </h4> </label>
</div>
...
<button class="btn btn1" type="submit">Cancel</button>
<input type="submit" name="submit" Value="Register" class="btn btn2">
</div>
</form>
<?php } ?>
