	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>	
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title head"><?php echo $row->firstName;?>'s&nbsp;Profile </h2>
...
<div class="col-sm-8">
<input type="text" name="bloodgroup" id="bloodgroup"  class="form-control" maxlength="10" value="<?php echo $row->bloodgroup;?>" required="required">
</div>
</div>
...
<input type="submit" name="update" Value="Update Profile" class="btn bg">
</div>
</form>
